...
<html lang="en">
    <head>
        ...
        @livewireStyles
        <title>Mes formulaires | Assistance Bot</title>
    </head>
    <body>
            ...
            <div class="page-wrapper">
                <div class="content container-fluid mt-3">
                    <div class="page-header">
                        <div class="row">
                            <div class="col">
                                <h3 class="page-title">Mes formulaires</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item">
                                        <a href="{{url('/dashboard')}}">Dashboard</a>
                                    </li>
                                    <li class="breadcrumb-item active">Mes formulaires</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    @endif
                    @livewire("liste-mes-formulaires-livewire")
                </div>
            </div>
