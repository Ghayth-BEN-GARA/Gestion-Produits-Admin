...
<html lang="en">
    <head>
        ...
        <title>Réinitialisation de mot de passe | Gestion des produits</title>
    </head>
    <body>
        <div class="main">
            <div class="">
                <div class="signup-content">
                    ...
                    <div class="signup-form">
                        <form method="post" class="register-form" id="update-password-form" name = "update-password-form" action = "{{url('/post-update-password-forget?id_user='.$_GET['id_user'])}}">
                            @csrf
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="email">Confirmation de mot de passe :</label>
